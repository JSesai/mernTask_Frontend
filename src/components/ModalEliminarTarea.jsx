...
const ModalEliminarTarea = () => {
    ...
    const { modalEliminarTarea, handleModalEliminarTarea, eliminarTarea } = useProyectos() //extraemos estado y fn para poder manejar el comportamiento del modal con la fn de useProyectos
